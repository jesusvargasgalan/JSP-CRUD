...
<html>
    ...
    <body class="fondo">>
        ...
        <a href="index.jsp" class="btn btn-primary btn-lg btn-block"><span class="glyphicon glyphicon-home"></span>Videojuego actualizado correctamente<br/> click para volver</button>
