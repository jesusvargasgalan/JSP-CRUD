        ...
        <div class="container">
            ...
            <div class=" card bg-info text-white text-center">
                ...
                <table class="table table-dark table-striped table-hover text-center">
                    <tr><th>Nombre</th><th>Codigo Videojuego</th><th>Codigo Plataforma</th><th>Nombre</th><th>Genero</th></tr>
                    <form method="get" action="grabaVideojuego.jsp">
                        <tr>        <td><select name="nomplat" >
                            ...
                            <td><input type="text" name="codvid" size="5"></td>
                            <td><input type="text" name="codplat" size="5"></td>
                            <td><input type="text" name="nomvid" size="15"></td>
