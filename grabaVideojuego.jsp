...
<html>
    ...
    <body class="fondo">>
        ...
        %>
        <br>
        <a href="index.jsp" class="btn btn-primary btn-lg btn-block" ><span class="glyphicon glyphicon-home"></span>Videojuego dado de alta correctamente<br/> click para volver</button>
